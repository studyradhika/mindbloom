...
import { Brain, Calendar, Star, Heart } from "lucide-react";
            ...
            <CardContent className="pt-12 pb-12">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg p-6 mb-8">
                <div className="flex items-center justify-center space-x-3 mb-4">
                  ...
                  <h3 className="text-xl font-semibold">Tomorrow's Session Preview</h3>
                </div>
                <div className="grid md:grid-cols-3 gap-4 text-center">
                  ...
                  <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-400">Day of Journey</div>
                  </div>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="pt-8 pb-8">
              ...
              <div className="grid md:grid-cols-3 gap-6 text-left">
                <div className="flex items-start space-x-3">
                  <div className="w-8 h-8 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center text-blue-600 font-bold flex-shrink-0">1</div>
                  <div>
                    <h4 className="font-semibold mb-2">Memory Challenge</h4>
                    <p className="text-gray-600 dark:text-gray-400 text-sm">
                      A gentle exercise to test and improve your working memory with colorful sequences
                    </p>
                  </div>
                </div>
                
                <div className="flex items-start space-x-3">
                  <div className="w-8 h-8 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center text-blue-600 font-bold flex-shrink-0">2</div>
                  <div>
                    <h4 className="font-semibold mb-2">Focus Training</h4>
                    <p className="text-gray-600 dark:text-gray-400 text-sm">
                      Practice selective attention by finding targets while ignoring distractions
                    </p>
                  </div>
                </div>
                
                <div className="flex items-start space-x-3">
                  <div className="w-8 h-8 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center text-blue-600 font-bold flex-shrink-0">3</div>
                  <div>
                    <h4 className="font-semibold mb-2">Word Skills</h4>
                    <p className="text-gray-600 dark:text-gray-400 text-sm">
                      Strengthen language abilities with word completion and association exercises
                    </p>
                  </div>
                </div>
              </div>
